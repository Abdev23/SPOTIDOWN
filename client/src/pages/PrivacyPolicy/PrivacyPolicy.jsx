  ...
  return (
    <div className='privacy-policy'>
      <main className='privacy-policy-container'>
        <h1> Privacy Policy for SpotiDown </h1>

        <p>
          At SpotiDown, accessible from https://spotidown.netlify.app,
          one of our main priorities is the privacy of our visitors.
          This Privacy Policy document contains types of information
          that is collected and recorded by SpotiDown and how we use it.
        </p>
        <p>
        ...
        <p>
          ...
          to our website with regards to the information that they shared and/or collect in SpotiDown.
        ...
        <p>
          ...
          and the reasons why you are asked to provide it, will be made clear to you
        ...
        <h2> Log Files </h2> 
        <p>
          SpotiDown follows a standard procedure of using log files.
        ...
        <p>
          Like any other website, SpotiDown uses 'cookies'.
        ...
        <p>
          ...
          It also uses cookies, known as DART cookies, to serve ads to our site visitors based
        ...
        <p>
          ...
          each of the advertising partners of SpotiDown.
        </p>
        <p>
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective advertisements
          and links that appear on SpotiDown, which are sent directly to users'
          browser.
        ...
        <p>
          Note that SpotiDown has no access to or control over these
          cookies that are used by third-party advertisers.
        </p>

        <h2> Third Party Privacy Policies </h2>
        <p>
          SpotiDown's Privacy Policy does not apply to other advertisers or websites.
        ...
        <p>
          ...
          the categories and specific pieces of personal data that a business has collected about consumers.
        </p>
        <p>
        ...
        <p>
          SpotiDown does not knowingly collect any Personal Identifiable Information from children
